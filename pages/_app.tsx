  ...
  <>
   <div className="fixed top-0 left-0 w-full text-bold flex flex-row z-50 text-black bg-slate-400 p-5 justify-between items-center">
        ...
        <div className="flex flex-row">
            ...
            <p className= {router.pathname == "/home" ? " px-3 hover:cursor-pointer text-bold text-black bg-gray-300 rounded" : "px-3 hover:cursor-pointer text-bold text-black "} onClick={() => redir('/home')}>
